...
public class MinimaxAlphaBeta {
	...
	private float maxValue(ChessView b, ArrayList<ArrayList<Integer>> state, float alpha, float beta, int depth) {
		if(depth > maxDepth)
	...
	private float minValue(ChessView b, ArrayList<ArrayList<Integer>> state, float alpha, float beta, int depth) {
		if(depth > maxDepth)
			return eval1(b, state, color);
	...
	public ArrayList<Integer> decision(final ChessView b) {
		// get maximum move
	...
	private float eval1(ChessView b, ArrayList<ArrayList<Integer>> moves, boolean currentColor) {
