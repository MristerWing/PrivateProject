    ...
    public ArrayList<ArrayList<Integer>> movePathCheck() {
        ...
        for(int i = -1; i<2; i++) {
            if(Math.abs(i) == 1) {
                ...
                if(y+i > 7 || y+i < 0) continue;
                ArrayList<Integer> tmp = new ArrayList<Integer>(Arrays.asList(y+i,x+2));
                if(ChessView.board[y+i][x+2].getColor() == "none")
                    movePath.add(tmp);
            }
        }
        //←↖
        ...
        for(int i = -1; i<2; i++) {
            if(Math.abs(i) == 1) {
                ...
                if(x+i > 7 || x+i < 0) continue;
                ArrayList<Integer> tmp = new ArrayList<Integer>(Arrays.asList(y-2,x+i));
                if(ChessView.board[y-2][x+i].getColor() == "none")
                    movePath.add(tmp);
            }
        }
        //↓↘
    ...
    public ArrayList<ArrayList<Integer>> checkPathCheck() {
        ...
        for(int i = -1; i<2; i++) {
            if(Math.abs(i) == 1) {
                ...
                if(y+i > 7 || y+i < 0) continue;
                ArrayList<Integer> tmp = new ArrayList<Integer>(Arrays.asList(y+i,x+2));
                if(ChessView.board[y+i][x+2].getColor() != getColor()) {
                    if(ChessView.board[y+i][x+2].getType() == "king") {
                        checkPath.add(tmp);
                        return checkPath;
                    }
                }
        ...
        for(int i = -1; i<2; i++) {
            if(Math.abs(i) == 1) {
                ...
                if(x+i > 7 || x+i < 0) continue;
                ArrayList<Integer> tmp = new ArrayList<Integer>(Arrays.asList(y-2,x+i));
                if(ChessView.board[y-2][x+i].getColor() != getColor()) {
                    if(ChessView.board[y-2][x+i].getType() == "king") {
                        checkPath.add(tmp);
                        return checkPath;
                    }
                }
