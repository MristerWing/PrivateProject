...
public class Queen extends Square{
        ...
        if(type == "diagonal"){
            ...
            if((direction == "rite") || (direction == "left")){
                ...
                for(int displace = 1; displace <= displaceMax; displace++){
                    if(direction == "rite"){
                        testSquare = ChessView.board[fromY][fromX + displace];
                ...
                for(int displace = 1; displace <= displaceMax; displace++){
                    ...
                    if(direction == "top"){
                        testSquare = ChessView.board[fromY - displace][fromX];
    ...
    public ArrayList<ArrayList<Integer>> attackPathCheck() {
        ...
        if(this.getColor() == "white") {
            ...
            for(int i = y - 1; i >= 0; i--) {
                ...
                attackPath.add(tmp);
                if(ChessView.board[i][x].getSymbol() != "BKi") {
                    if(ChessView.board[i][x].getType() != "none") {
                        break;
                    }
                }
            }
            ...
            for(int i = x - 1; i >= 0; i--) {
                ...
                attackPath.add(tmp);
                if(ChessView.board[y][i].getSymbol() != "BKi") {
            ...
            for(int i = y - 1; i >= 0; i--) {
                ArrayList<Integer> tmp = new ArrayList<Integer>(Arrays.asList(i, x));
                attackPath.add(tmp);
                if(ChessView.board[i][x].getSymbol() != "WKi") {
                    if(ChessView.board[i][x].getType() != "none") {
                        break;
                    }
                }
            ...
            for(int i = x - 1; i >= 0; i--) {
                ArrayList<Integer> tmp = new ArrayList<Integer>(Arrays.asList(y, i));
                attackPath.add(tmp);
                if(ChessView.board[y][i].getSymbol() != "WKi") {
                    if(ChessView.board[y][i].getType() != "none") {
                        break;
                    }
                }
    ...
    public ArrayList<ArrayList<Integer>> movePathCheck() {
        ...
        if(this.getColor() == "white") {
            ...
            for(int i = y - 1; i >= 0; i--) {
                ArrayList<Integer> tmp = new ArrayList<Integer>(Arrays.asList(i, x));
                if(ChessView.board[i][x].getColor() != "none") {
                    break;
                }
                movePath.add(tmp);
            }
            ...
            for(int i = x - 1; i >= 0; i--) {
                ArrayList<Integer> tmp = new ArrayList<Integer>(Arrays.asList(y, i));
                if(ChessView.board[y][i].getColor() != "none") {
                    break;
                }
                movePath.add(tmp);
            }
            ...
            for(int i = y - 1; i >= 0; i--) {
                if(j<0) break;
                ArrayList<Integer> tmp = new ArrayList<Integer>(Arrays.asList(i, j));
                if(ChessView.board[i][j].getColor() != "none") {
                    break;
                }
                movePath.add(tmp);
                j--;
    ...
    public ArrayList<ArrayList<Integer>> aiPath(){
        ...
        for(int i = y - 1; i >= 0; i--) {
            ArrayList<Integer> tmp = new ArrayList<Integer>(Arrays.asList(i, x));
            if(ChessView.board[i][x].getColor() == getColor())  break;
            if(ChessView.board[i][x].getColor() != getColor()) {
                aiPath.add(tmp);
                if(ChessView.board[i][x].getColor() != "none") break;
            }
        }
        //남
        for(int i = y + 1; i <= 7; i++) {
        ...
        for(int i = x - 1; i >= 0; i--) {
            ArrayList<Integer> tmp = new ArrayList<Integer>(Arrays.asList(y, i));
            if(ChessView.board[y][i].getColor() == getColor())  break;
            if(ChessView.board[y][i].getColor() != getColor()) {
                aiPath.add(tmp);
                if(ChessView.board[y][i].getColor() != "none") break;
            }
        }
        //동
        for(int i = x + 1; i <= 7; i++) {
