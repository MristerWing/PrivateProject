...
<script type="text/javascript" src="${root}/javascript/fileboard/update.js"></script>
</head>
<body>
	...
	<div align="center" class="wrap">
		...
		<form class="mainContainer" action="${root}/fileboard/updateOk.do?pageNumber=${pageNumber}" method="post" onsubmit="return boardForm(this, '${boardDto.password}')">
			...
			<div class="liner" style="border-bottom-width: 0px;">
				...
				<input type="button" value="목록보기" onclick="javascript:location.href='${root}/fileboard/list.do?pageNumber=${pageNumber}'"/>
			</div>
		</form>
	</div>
</body>
