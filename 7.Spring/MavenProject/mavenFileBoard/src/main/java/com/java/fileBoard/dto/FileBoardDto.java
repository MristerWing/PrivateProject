...
public class FileBoardDto {
	...
	public FileBoardDto(int boardNumber, String writer, String email,
			String subject, String content, String password, Date writeDate,
			int readCount, int groupNumber, int sequenceNumber,
			int sequenceLevel, String fileName, String path, long fileSize) {
		super();
	...
	public void setDataMap(HashMap<String, String> dataMap) {
		...
		if (dataMap.get("sequenceNumber") != null)
			this.setSequenceNumber(
					Integer.parseInt(dataMap.get("sequenceNumber")));
		if (dataMap.get("sequenceLevel") != null)
			this.setSequenceLevel(
					Integer.parseInt(dataMap.get("sequenceLevel")));
	...
	public String toString() {
		return "BoardDto [boardNumber=" + boardNumber + ", writer=" + writer
				+ ", email=" + email + ", subject=" + subject + ", content="
				+ content + ", password=" + password + ", writeDate="
				+ writeDate + ", readCount=" + readCount + ", groupNumber="
				+ groupNumber + ", sequenceNumber=" + sequenceNumber
				+ ", sequenceLevel=" + sequenceLevel + ", fileName=" + fileName
