...
<link rel="stylesheet" href="${root}/css/board/style.css" />
...
<body>
	<div align="center" class="wrap">
		...
		<form class="mainContainer" action="${root}/board/writeOk.do?pageNumber=${pageNumber}" method="post" onsubmit="return boardForm(this)">
